    ...
    <div class="max-w-3xl mx-auto">
        <div class="glass-card">
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="password" class="label-field">Password <span class="text-red-500">*</span></label>
                        <input type="password" name="password" id="password" required class="input-field">
                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                    </div>

                    <div>
                        <label for="password_confirmation" class="label-field">Confirm Password <span class="text-red-500">*</span></label>
